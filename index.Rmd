...
Tracks changes to all files and subfolders contained in the **repository** (which is just the parent folder).
...
**AND**
Can be synchronized with a server so that data & its changes are backed up to the cloud.

## Using Git Locally

Git can be run via command line but we will use GitHub Desktop.
...
<p align="center">
![](./figures/git_clone_repo.png){width=50%}
<br><br>
![](./figures/placeholder.png){width=50%}
</p>
...
The Git repository contains a time-series of commits.
...
* Navigate to the GitHub Desktop staging area and commit the R Notebook file you copy/pasted to the repository.
  ...
  - GitHub Desktop may prompt you to push to origin -- do **NOT** do that yet!
...
When it finds a conflict, GitHub will ask you to resolve it manually.
...
* Git can be used with an online server (e.g., GitHub)
  ...
  *e.g., [this website is hosted on GitHub](https://github.com/EvoNerd/THEE_2025reproducibility)*
