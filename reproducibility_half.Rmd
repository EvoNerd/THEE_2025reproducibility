...
(To progress the slideshow above: click inside the square then use the arrow keys, $\leftarrow$ and $\rightarrow$. For more options, press the "h" key.)
...
## 2. Automate <img src="./figures/automate_all_the_things.avif" class="toc-icon" style="float: right; width: 25%; margin-left: 10px;" />
...
- To do find+replace you can go to RStudio: **Edit ➜  Find...**

- You can also use a hotkey to get to find+replace, for Windows: **Ctrl + F** *or* for Mac: **Cmd   + F**

</div>



## 3. Hoard <img src="./figures/hoarder_icon.png" class="toc-icon" style="float: right; width: 25%; margin-left: 10px;" />
...
version control (e.g., [git](github_half.html#What_is_Git)), online repositories (e.g., [GitHub](github_half.html#Using_Git_with_a_Server))
...
## 4. Share <img src="./figures/share_icon.png" class="toc-icon" style="float: right; width: 25%; margin-left: 10px;" />
...
online repositories for data (e.g., Dryad), code (e.g., [GitHub](github_half.html#Using_Git_with_a_Server)), and papers (e.g., EcoEvoRxiv)

We will learn how to use Git and GitHub in [the second half of the module.](github_half.html)
